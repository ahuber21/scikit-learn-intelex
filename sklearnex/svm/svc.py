    ...
    def _onedal_gpu_supported(self, method_name, *data):
        if method_name == "svm.SVC.fit":
            ...
            return (
                ...
                and hasattr(self, "_class_count")
                and self._class_count == 2
                and hasattr(self, "_is_sparse")
                and not self._is_sparse
            )
        if method_name in [
            "svm.SVC.predict",
            "svm.SVC.predict_proba",
            ...
            return hasattr(self, "_onedal_estimator") and self._onedal_gpu_supported(
                "svm.SVC.fit", *data
            )
